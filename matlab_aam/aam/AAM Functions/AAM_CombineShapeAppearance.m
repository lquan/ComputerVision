function ShapeAppearanceData=AAM_CombineShapeAppearance(TrainingData,ShapeData,AppearanceData,options)
...
Ws = AAM_Weights(TrainingData,ShapeData,AppearanceData,options);
