%% parameters
% when changing doPCA you need to train an appropriate network
clear;clc;
doPCA = false; % use PCA on the data
...
[pose_results, results] = convertResults(yaw_predictions,pitch_predictions);
